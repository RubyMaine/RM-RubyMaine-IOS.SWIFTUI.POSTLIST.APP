...
var data = [
    ListData(title: "LazyHGrid в SwiftUI (часть 1/3)", postType: ["iOS","SwiftUI", "Xcode"], date: "05 Jun", Image: "LazyGrid",Color: Color.lighterPink, percentage: 0.30, stars: 5),
    ListData(title: "LazyHGrid и LazyVGrid в SwiftUI ", postType: ["iOS","SwiftUI", "Xcode"], date: "15 dec", Image: "LazyGrid2",Color: Color.lighterGray, percentage: 0.25, stars: 4),
    ListData(title: "Как определить светлую/темную тему", postType: ["iOS","SwiftUI", "Xcode"], date: "20 Nov", Image: "themeDetector",Color: Color.lightOrange, percentage: 0.10, stars: 3),
    ListData(title: "Цвет градиента в SWiftUI", postType: ["iOS","SwiftUI", "Xcode"], date: "10 Jun", Image: "try1",Color: Color.lightPink, percentage: 0.45, stars: 2),
    ListData(title: "Как определить светлую/темную тему", postType: ["iOS","SwiftUI", "Xcode"], date: "05 Feb", Image: "themeDetector",Color: Color.lightGray, percentage: 0.86, stars: 5),
    ListData(title: "LazyHGrid в SwiftUI (часть 2/3)", postType: ["iOS","SwiftUI", "Xcode"], date: "15 Dec", Image: "LazyGrid",Color: Color.lightOrange, percentage: 0.30, stars: 3),
    ListData(title: "LazyHGrid и LazyVGrid в SwiftUI ", postType: ["iOS","SwiftUI", "Xcode"], date: "15 dec", Image: "LazyGrid2",Color: Color.lighterPink, percentage: 0.25, stars: 2),
    ListData(title: "Как определить светлую/темную тему", postType: ["iOS","SwiftUI", "Xcode"], date: "15 dec", Image: "themeDetector",Color: Color.lighterGray, percentage: 0.10, stars: 3),
    ListData(title: "Цвет градиента в SWiftUI", postType: ["iOS","SwiftUI", "Xcode"], date: "15 dec", Image: "try1",Color: Color.lightGray, percentage: 0.45, stars: 4),
    ListData(title: "Как определить светлую/темную тему", postType: ["iOS","SwiftUI", "Xcode"], date: "15 dec", Image: "themeDetector",Color: Color.lightOrange, percentage: 0.86, stars: 5)
]
                            ...
                            HStack{
                                ...
                                VStack(alignment: .leading, spacing: 8) {
                                    ...
                                    Text(m.title)
                                        ...
                                        .font(.subheadline)
                                        .lineLimit(1)
                                    Text("Счастливая программа RubyMaine")
                                        .font(.caption2)
...
struct GroupedListFooter: View {
    var body: some View {
        HStack {
            ...
            Text("Пожалуйста, поддержите меня RubyMaine")
        }
    }
}
...
struct GroupedListHeader: View {
    var body: some View {
        HStack {
            ...
            Text("Все посты от программиста RubyMaine")
        }
    }
}
...
//                            .overlay(LinearGradient(gradient: Gradient(colors: [post.Color, post.Color.opacity(0.1)]), startPoint: .bottom, endPoint: .top))
                    ...
                    VStack(alignment: .leading,spacing: 30) {
                        Text(post.title)
                            ...
                            .fontWeight(.bold)
                            .foregroundColor(.black)
                        Text("Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s").lineSpacing(10)
                    }.padding()
                    Spacer()
                    Button(action: {}) {
                        HStack {
